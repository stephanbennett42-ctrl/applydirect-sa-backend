...
-- 2. Reset database records cleanly
SET FOREIGN_KEY_CHECKS = 0;
TRUNCATE TABLE institutions;
SET FOREIGN_KEY_CHECKS = 1;

-- 3. Insert All Public Universities & Colleges across 9 Provinces
...
VALUES 
  ...
  ('Northlink TVET College', 'TVET College', 'Western Cape', 'Open', 0.00, '2026-01-15', '2026-10-31', 'https://www.northlink.co.za', 'https://www.northlink.co.za/apply/'),
  ('Eduvos (Tyger Valley Campus)', 'Private College', 'Western Cape', 'Open', 0.00, '2026-01-01', '2026-11-30', 'https://www.eduvos.com', 'https://www.eduvos.com/apply/'),
